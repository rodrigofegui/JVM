...
void iniciar_bytecodes (){
    // 0 (0x00)
    bytecodes.push_back({"nop", FUNC(_nop)});

    // 1 (0x01)
    bytecodes.push_back({"aconst_null", FUNC(_aconst_null)});
    // 2 (0x02)k
    bytecodes.push_back({"iconst_m1", FUNC(_iconst_m1)});
    // 3 (0x03)
    bytecodes.push_back({"iconst_0", FUNC(_iconst_0)});
    // 4 (0x04)
    bytecodes.push_back({"iconst_1", FUNC(_iconst_1)});
    // 5 (0x05)
    bytecodes.push_back({"iconst_2", FUNC(_iconst_2)});

    // 6 (0x06)
    bytecodes.push_back({"iconst_3", FUNC(_iconst_3)});
    // 7 (0x07)
    bytecodes.push_back({"iconst_4", FUNC(_iconst_4)});
    // 8 (0x08)
    bytecodes.push_back({"iconst_5", FUNC(_iconst_5)});
    // 9 (0x09)
    bytecodes.push_back({"lconst_0", FUNC(_lconst_0)});
    // 10 (0x0A)
    bytecodes.push_back({"lconst_1", FUNC(_lconst_1)});

    // 11 (0x0B)
    bytecodes.push_back({"fconst_0", FUNC(_fconst_0)});
    // 12 (0x0C)
    bytecodes.push_back({"fconst_1", FUNC(_fconst_1)});
    // 13 (0x0D)
    bytecodes.push_back({"fconst_2", FUNC(_fconst_2)});
    // 14 (0x0E)
    bytecodes.push_back({"dconst_0", FUNC(_dconst_0)});
    // 15 (0x0F)
    bytecodes.push_back({"dconst_1", FUNC(_dconst_1)});

    // 16 (0x10)
    bytecodes.push_back({"bipush", FUNC(_bipush)});
    // 17 (0x11)
    bytecodes.push_back({"sipush", FUNC(_sipush)});
    // 18 (0x12)
    bytecodes.push_back({"ldc", FUNC(_ldc)});
    // 19 (0x13)
    bytecodes.push_back({"ldc_w", FUNC(_ldc_w)});
    // 20 (0x14)
    bytecodes.push_back({"ldc2_w", FUNC(_ldc2_w)});

    // 21 (0x15)
    bytecodes.push_back({"iload", FUNC(_iload)});
    // 22 (0x16)
    bytecodes.push_back({"lload", FUNC(_lload)});
    // 23 (0x17)
    bytecodes.push_back({"fload", FUNC(_fload)});
    // 24 (0x18)
    bytecodes.push_back({"dload", FUNC(_dload)});
    // 25 (0x19)
    bytecodes.push_back({"aload", FUNC(_aload)});

    // 26 (0x1A)
    bytecodes.push_back({"iload_0", FUNC(_iload_0)});
    // 27 (0x1B)
    bytecodes.push_back({"iload_1", FUNC(_iload_1)});
    // 28 (0x1C)
    bytecodes.push_back({"iload_2", FUNC(_iload_2)});
    // 29 (0x1D)
    bytecodes.push_back({"iload_3", FUNC(_iload_3)});
    // 30 (0x1E)
    bytecodes.push_back({"lload_0", FUNC(_lload_0)});

    // 31 (0x1F)
    bytecodes.push_back({"lload_1", FUNC(_lload_1)});
    // 32 (0x20)
    bytecodes.push_back({"lload_2", FUNC(_lload_2)});
    // 33 (0x21)
    bytecodes.push_back({"lload_3", FUNC(_lload_3)});
    // 34 (0x22)
    bytecodes.push_back({"fload_0", FUNC(_fload_0)});
    // 35 (0x23)
    bytecodes.push_back({"fload_1", FUNC(_fload_1)});

    // 36 (0x24)
    bytecodes.push_back({"fload_2", FUNC(_fload_2)});
    // 37 (0x25)
    bytecodes.push_back({"fload_3", FUNC(_fload_3)});
    // 38 (0x26)
    bytecodes.push_back({"dload_0", FUNC(_dload_0)});
    // 39 (0x27)
    bytecodes.push_back({"dload_1", FUNC(_dload_1)});
    // 40 (0x28)
    bytecodes.push_back({"dload_2", FUNC(_dload_2)});

    // 41 (0x29)
    bytecodes.push_back({"dload_3", FUNC(_dload_3)});
    // 42 (0x2A)
    bytecodes.push_back({"aload_0", FUNC(_aload_0)});
    // 43 (0x2B)
    bytecodes.push_back({"aload_1", FUNC(_aload_1)});
    // 44 (0x2C)
    bytecodes.push_back({"aload_2", FUNC(_aload_2)});
    // 45 (0x2D)
    bytecodes.push_back({"aload_3", FUNC(_aload_3)});

    // 46 (0x2E)
    bytecodes.push_back({"iaload", FUNC(_iaload)});
    // 47 (0x2F)
    bytecodes.push_back({"laload", FUNC(_laload)});
    // 48 (0x30)
    bytecodes.push_back({"faload", FUNC(_faload)});
    // 49 (0x31)
    bytecodes.push_back({"daload", FUNC(_daload)});
    // 50 (0x32)
    bytecodes.push_back({"aaload", FUNC(_aaload)});

    // 51 (0x33)
    bytecodes.push_back({"baload", FUNC(_baload)});
    // 52 (0x34)
    bytecodes.push_back({"caload", FUNC(_caload)});
    // 53 (0x35)
    bytecodes.push_back({"saload", FUNC(_saload)});
    // 54 (0x36)
    bytecodes.push_back({"istore", FUNC(_istore)});
    // 55 (0x37)
    bytecodes.push_back({"lstore", FUNC(_lstore)});

    // 56 (0x38)
    bytecodes.push_back({"fstore", FUNC(_fstore)});
    // 57 (0x39)
    bytecodes.push_back({"dstore", FUNC(_dstore)});
    // 58 (0x3A)
    bytecodes.push_back({"astore", FUNC(_astore)});
    // 59 (0x3B)
    bytecodes.push_back({"istore_0", FUNC(_istore_0)});
    // 60 (0x3C)
    bytecodes.push_back({"istore_1", FUNC(_istore_1)});

    // 61 (0x3D)
    bytecodes.push_back({"istore_2", FUNC(_istore_2)});
    // 62 (0x3E)
    bytecodes.push_back({"istore_3", FUNC(_istore_3)});
    // 63 (0x3F)
    bytecodes.push_back({"lstore_0", FUNC(_lstore_0)});
    // 64 (0x40)
    bytecodes.push_back({"lstore_1", FUNC(_lstore_1)});
    // 65 (0x41)
    bytecodes.push_back({"lstore_2", FUNC(_lstore_2)});

    // 66 (0x42)
    bytecodes.push_back({"lstore_3", FUNC(_lstore_3)});
    // 67 (0x43)
    bytecodes.push_back({"fstore_0", FUNC(_fstore_0)});
    // 68 (0x44)
    bytecodes.push_back({"fstore_1", FUNC(_fstore_1)});
    // 69 (0x45)
    bytecodes.push_back({"fstore_2", FUNC(_fstore_2)});
    // 70 (0x46)
    bytecodes.push_back({"fstore_3", FUNC(_fstore_3)});

    // 71 (0x47)
    bytecodes.push_back({"dstore_0", FUNC(_dstore_0)});
    // 72 (0x48)
    bytecodes.push_back({"dstore_1", FUNC(_dstore_1)});
    // 73 (0x49)
    bytecodes.push_back({"dstore_2", FUNC(_dstore_2)});
    // 74 (0x4A)
    bytecodes.push_back({"dstore_3", FUNC(_dstore_3)});
    // 75 (0x4B)
    bytecodes.push_back({"astore_0", FUNC(_astore_0)});

    // 76 (0x4C)
    bytecodes.push_back({"astore_1", FUNC(_astore_1)});
    // 77 (0x4D)
    bytecodes.push_back({"astore_2", FUNC(_astore_2)});
    // 78 (0x4E)
    bytecodes.push_back({"astore_3", FUNC(_astore_3)});
    // 79 (0x4F)
    bytecodes.push_back({"iastore", FUNC(_iastore)});
    // 80 (0x50)
    bytecodes.push_back({"lastore", FUNC(_lastore)});

    // 81 (0x51)
    bytecodes.push_back({"fastore", FUNC(_fastore)});
    // 82 (0x52)
    bytecodes.push_back({"dastore", FUNC(_dastore)});
    // 83 (0x53)
    bytecodes.push_back({"aastore", FUNC(_aastore)});
    // 84 (0x54)
    bytecodes.push_back({"bastore", FUNC(_bastore)});
    // 85 (0x55)
    bytecodes.push_back({"castore", FUNC(_castore)});

    // 86 (0x56)
    bytecodes.push_back({"sastore", FUNC(_sastore)});
    // 87 (0x57)
    bytecodes.push_back({"pop", FUNC(_pop)});
    // 88 (0x58)
    bytecodes.push_back({"pop2", FUNC(_pop2)});
    // 89 (0x59)
    bytecodes.push_back({"dup", FUNC(_dup)});
    // 90 (0x5A)
    bytecodes.push_back({"dup_x1", FUNC(_dup_x1)});

    // 91 (0x5B)
    bytecodes.push_back({"dup_x2", FUNC(_dup_x2)});
    // 92 (0x5C)
    bytecodes.push_back({"dup2", FUNC(_dup2)});
    // 93 (0x5D)
    bytecodes.push_back({"dup2_x1", FUNC(_dup2_x1)});
    // 94 (0x5E)
    bytecodes.push_back({"dup2_x2", FUNC(_dup2_x2)});
    // 95 (0x5F)
    bytecodes.push_back({"swap", FUNC(_swap)});

    // 96 (0x60)
    bytecodes.push_back({"iadd", FUNC(_iadd)});
    // 97 (0x61)
    bytecodes.push_back({"ladd", FUNC(_ladd)});
    // 98 (0x62)
    bytecodes.push_back({"fadd", FUNC(_fadd)});
    // 99 (0x63)
    bytecodes.push_back({"dadd", FUNC(_dadd)});
    // 100 (0x64)
    bytecodes.push_back({"isub", FUNC(_isub)});

    // 101 (0x65)
    bytecodes.push_back({"lsub", FUNC(_lsub)});
    // 102 (0x66)
    bytecodes.push_back({"fsub", FUNC(_fsub)});
    // 103 (0x67)
    bytecodes.push_back({"dsub", FUNC(_dsub)});
    // 104 (0x68)
    bytecodes.push_back({"imul", FUNC(_imul)});
    // 105 (0x69)
    bytecodes.push_back({"lmul", FUNC(_lmul)});

    // 106 (0x6A)
    bytecodes.push_back({"fmul", FUNC(_fmul)});
    // 107 (0x6B)
    bytecodes.push_back({"dmul", FUNC(_dmul)});
    // 108 (0x6C)
    bytecodes.push_back({"idiv", FUNC(_idiv)});
    // 109 (0x6D)
    bytecodes.push_back({"ldiv", FUNC(_ldiv)});
    // 110 (0x6E)
    bytecodes.push_back({"fdiv", FUNC(_fdiv)});

    // 111 (0x6F)
    bytecodes.push_back({"ddiv", FUNC(_ddiv)});
    // 112 (0x70)
    bytecodes.push_back({"irem", FUNC(_irem)});
    // 113 (0x71)
    bytecodes.push_back({"lrem", FUNC(_lrem)});
    // 114 (0x72)
    bytecodes.push_back({"frem", FUNC(_frem)});
    // 115 (0x73)
    bytecodes.push_back({"drem", FUNC(_drem)});

    // 116 (0x74)
    bytecodes.push_back({"ineg", FUNC(_ineg)});
    // 117 (0x75)
    bytecodes.push_back({"lneg", FUNC(_lneg)});
    // 118 (0x76)
    bytecodes.push_back({"fneg", FUNC(_fneg)});
    // 119 (0x77)
    bytecodes.push_back({"dneg", FUNC(_dneg)});
    // 120 (0x78)
    bytecodes.push_back({"ishl", FUNC(_ishl)});

    // 121 (0x79)
    bytecodes.push_back({"lshl", FUNC(_lshl)});
    // 122 (0x7A)
    bytecodes.push_back({"ishr", FUNC(_ishr)});
    // 123 (0x7B)
    bytecodes.push_back({"lshr", FUNC(_lshr)});
    // 124 (0x7C)
    bytecodes.push_back({"iushr", FUNC(_iushr)});
    // 125 (0x7D)
    bytecodes.push_back({"lushr", FUNC(_lushr)});

    // 126 (0x7E)
    bytecodes.push_back({"iand", FUNC(_iand)});
    // 127 (0x7F)
    bytecodes.push_back({"land", FUNC(_land)});
    // 128 (0x80)
    bytecodes.push_back({"ior", FUNC(_ior)});
    // 129 (0x81)
    bytecodes.push_back({"lor", FUNC(_lor)});
    // 130 (0x82)
    bytecodes.push_back({"ixor", FUNC(_ixor)});

    // 131 (0x83)
    bytecodes.push_back({"lxor", FUNC(_lxor)});
    // 132 (0x84)
    bytecodes.push_back({"iinc", FUNC(_iinc)});
    // 133 (0x85)
    bytecodes.push_back({"i2l", FUNC(_i2l)});
    // 134 (0x86)
    bytecodes.push_back({"i2f", FUNC(_i2f)});
    // 135 (0x87)
    bytecodes.push_back({"i2d", FUNC(_i2d)});

    // 136 (0x88)
    bytecodes.push_back({"l2i", FUNC(_l2i)});
    // 137 (0x89)
    bytecodes.push_back({"l2f", FUNC(_l2f)});
    // 138 (0x8A)
    bytecodes.push_back({"l2d", FUNC(_l2d)});
    // 139 (0x8B)
    bytecodes.push_back({"f2i", FUNC(_f2i)});
    // 140 (0x8C)
    bytecodes.push_back({"f2l", FUNC(_f2l)});

    // 141 (0x8D)
    bytecodes.push_back({"f2d", FUNC(_f2d)});
    // 142 (0x8E)
    bytecodes.push_back({"d2i", FUNC(_d2i)});
    // 143 (0x8F)
    bytecodes.push_back({"d2l", FUNC(_d2l)});
    // 144 (0x90)
    bytecodes.push_back({"d2f", FUNC(_d2f)});
    // 145 (0x91)
    bytecodes.push_back({"i2b", FUNC(_i2b)});

    // 146 (0x92)
    bytecodes.push_back({"i2c", FUNC(_i2c)});
    // 147 (0x93)
    bytecodes.push_back({"i2s", FUNC(_i2s)});
    // 148 (0x94)
    bytecodes.push_back({"lcmp", FUNC(_lcmp)});
    // 149 (0x95)
    bytecodes.push_back({"fcmpl", FUNC(_fcmpl)});
    // 150 (0x96)
    bytecodes.push_back({"fcmpg", FUNC(_fcmpg)});

    // 151 (0x97)
    bytecodes.push_back({"dcmpl", FUNC(_dcmpl)});
    // 152 (0x98)
    bytecodes.push_back({"dcmpg", FUNC(_dcmpg)});
    // 153 (0x99)
    bytecodes.push_back({"ifeq", FUNC(_ifeq)});
    // 154 (0x9A)
    bytecodes.push_back({"ifne", FUNC(_ifne)});
    // 155 (0x9B)
    bytecodes.push_back({"iflt", FUNC(_iflt)});

    // 156 (0x9C)
    bytecodes.push_back({"ifge", FUNC(_ifge)});
    // 157 (0x9D)
    bytecodes.push_back({"ifgt", FUNC(_ifgt)});
    // 158 (0x9E)
    bytecodes.push_back({"ifle", FUNC(_ifle)});
    // 159 (0x9F)
    bytecodes.push_back({"if_icmpeq", FUNC(_if_icmpeq)});
    // 160 (0xA0)
    bytecodes.push_back({"if_icmpne", FUNC(_if_icmpne)});

    // 161 (0xA1)
    bytecodes.push_back({"if_icmplt", FUNC(_if_icmplt)});
    // 162 (0xA2)
    bytecodes.push_back({"if_icmpge", FUNC(_if_icmpge)});
    // 163 (0xA3)
    bytecodes.push_back({"if_icmpgt", FUNC(_if_icmpgt)});
    // 164 (0xA4)
    bytecodes.push_back({"if_icmple", FUNC(_if_icmple)});
    // 165 (0xA5)
    bytecodes.push_back({"if_acmpeg", FUNC(_if_acmpeg)});

    // 166 (0xA6)
    bytecodes.push_back({"if_acmpne", FUNC(_if_acmpne)});
    // 167 (0xA7)
    bytecodes.push_back({"goto", FUNC(_goto)});
    // 168 (0xA8)
    bytecodes.push_back({"jsr", FUNC(_jsr)});
    // 169 (0xA9)
    bytecodes.push_back({"ret", FUNC(_ret)});
    // 170 (0xAA)
    bytecodes.push_back({"tableswitch", FUNC(_tableswitch)});

    // 171 (0xAB)
    bytecodes.push_back({"lookupswitch", FUNC(_lookupswitch)});
    // 172 (0xAC)
    bytecodes.push_back({"ireturn", FUNC(_ireturn)});
    // 173 (0xAD)
    bytecodes.push_back({"lreturn", FUNC(_lreturn)});
    // 174 (0xAE)
    bytecodes.push_back({"freturn", FUNC(_freturn)});
    // 175 (0xAF)
    bytecodes.push_back({"dreturn", FUNC(_dreturn)});

    // 176 (0xB0)
    bytecodes.push_back({"areturn", FUNC(_areturn)});
    // 177 (0xB1)
    bytecodes.push_back({"return", FUNC(_return)});
    // 178 (0xB2)
    bytecodes.push_back({"getstatic", FUNC(_getstatic)});
    // 179 (0xB3)
    bytecodes.push_back({"putstatic", FUNC(_putstatic)});
    // 180 (0xB4)
    bytecodes.push_back({"getfield", FUNC(_getfield)});

    // 181 (0xB5)
    bytecodes.push_back({"putfield", FUNC(_putfield)});
    // 182 (0xB6)
    bytecodes.push_back({"invokevirtual", FUNC(_invokevirtual)});
    // 183 (0xB7)
    bytecodes.push_back({"invokespecial", FUNC(_invokespecial)});
    // 184 (0xB8)
    bytecodes.push_back({"invokestatic", FUNC(_invokestatic)});
    // 185 (0xB9)
    bytecodes.push_back({"invokeinterface", FUNC(_invokeinterface)});

    // 186 (0xBA)
    bytecodes.push_back({"invokedynamic", FUNC(_invokedynamic)});
    // 187 (0xBB)
    bytecodes.push_back({"new", FUNC(_new)});
    // 188 (0xBC)
    bytecodes.push_back({"newarray", FUNC(_newarray)});
    // 189 (0xBD)
    bytecodes.push_back({"anewarray", FUNC(_anewarray)});
    // 190 (0xBE)
    bytecodes.push_back({"arraylength", FUNC(_arraylength)});

    // 191 (0xBF)
    bytecodes.push_back({"athrow", FUNC(_athrow)});
    // 192 (0xC0)
    bytecodes.push_back({"checkcast", FUNC(_checkcast)});
    // 193 (0xC1)
    bytecodes.push_back({"instanceof", FUNC(_instanceof)});
    // 194 (0xC2)
    bytecodes.push_back({"monitorenter", FUNC(_monitorenter)});
    // 195 (0xC3)
    bytecodes.push_back({"monitorexit", FUNC(_monitorexit)});

    // 196 (0xC4)
    bytecodes.push_back({"wide", FUNC(_wide)});
    // 197 (0xC5)
    bytecodes.push_back({"multianewarray", FUNC(_multianewarray)});
    // 198 (0xC6)
    bytecodes.push_back({"ifnull", FUNC(_ifnull)});
    // 199 (0xC7)
    bytecodes.push_back({"ifnonnull", FUNC(_ifnonnull)});
    // 200 (0xC8)
    bytecodes.push_back({"goto_w", FUNC(_goto_w)});

    // 201 (0xC9)
    bytecodes.push_back({"jsr_w", FUNC(_jsr_w)});
    // 202 (0xCA)
    bytecodes.push_back({"break_point", FUNC(_break_point)});
    // 203 (0xCB)
    bytecodes.push_back({"-", FUNC(_undef)});
    // 204 (0xCC)
    bytecodes.push_back({"-", FUNC(_undef)});
    // 205 (0xCD)
    bytecodes.push_back({"-", FUNC(_undef)});
    ...
    bytecodes.push_back({"-", FUNC(_undef)});
    // 254 (0xFE)
    bytecodes.push_back({"impdep_1", FUNC(_impdep_1)});
    // 255 (0xFF)
    bytecodes.push_back({"impdep_2", FUNC(_impdep_2)});
}
...
int manipulador_wide (const std::vector<u1> codigo, const u2 c_pos, const u1 e_interpretador){
    u1 prox_bytecode = codigo[c_pos + 1];
    if (!bytecodes[prox_bytecode].mnemonico.compare("iinc"))
        return 5;
